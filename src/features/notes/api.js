...
export const fetchNotesByUser = (userId, { from = 0, to = 29 } = {})=> supabase.from('notes').select(NOTE_FIELDS).eq('created_by',userId).order('created_at',{ascending:false}).range(from,to);
