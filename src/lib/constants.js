...
export const USERS = [
  { id: 'user1', name: 'Марія',   email: 'utkinam@wayplanner.app',   password: 'maria2024',   color: '#e8622a', avatar: '🧡' },
  { id: 'user2', name: 'Богдан',  email: 'pishcholinb@wayplanner.app',  password: 'bohdan2024',  color: '#2a7de8', avatar: '💙' },
  { id: 'user3', name: 'Вікторія',email: 'kuschn@wayplanner.app',password: 'nikita2024',color: '#2abf6e', avatar: '💚' },
]
