...
export const USERS = [
  { id: 'user1', name: 'Аліна',   email: 'alina@wayplanner.app',   password: 'alina2024',   color: '#e8622a', avatar: '🧡' },
  { id: 'user2', name: 'Богдан',  email: 'bohdan@wayplanner.app',  password: 'bohdan2024',  color: '#2a7de8', avatar: '💙' },
  { id: 'user3', name: 'Вікторія',email: 'viktoria@wayplanner.app',password: 'viktoria2024',color: '#2abf6e', avatar: '💚' },
]
