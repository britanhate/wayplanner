      ...
      {!minimized && (
        <>
          ...
          <div className="rp-actions-row">
            ...
            >
              {building ? (
                <><span style={{ animation: "spin 1s linear infinite", display: "inline-flex" }}>{Icons.loader}</span> Будуємо...</>
              ) : (
            ...
            <div className="rp-results">
              {summary && (
                <div className="rp-summary-bar">
                  ...
                  {result.legs[0]?.via && (
                    <span className="rp-summary-via">via {result.legs[0].via}</span>
                  )}
                </div>
              )}
                          ...
                          <div className="rp-step-content">
                            <div className="rp-step-main">
                              ...
                              <div>
                                ...
                                {step.operator && (
                                  <div className="rp-step-op">{step.operator}</div>
                                )}
                              </div>
