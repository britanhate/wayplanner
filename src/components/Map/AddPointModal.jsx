      ...
      <div className="modal-box" onClick={e => e.stopPropagation()}>
        ...
        <div className="modal-body">
          ...
          <input className="field-inp" value={name} onChange={e => setName(e.target.value)}
            placeholder="Назва місця..." autoFocus />
          ...
          <input className="field-inp" value={description}
          ...
          <div className="field-row">
            <div style={{ flex: 1 }}>
              ...
              <input className="field-inp" type="date" value={pointDate}
          ...
          <div className="field-row">
            <div style={{ flex: 1 }}>
              ...
              <input className="field-inp" type="number" value={estimatedCost}
          ...
          <textarea className="field-textarea" value={comment}
            onChange={e => setComment(e.target.value)}
            placeholder="Додаткові нотатки..." rows={2} />
        </div>
